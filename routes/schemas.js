...
//kommer alltid skicka ett object så gör att de kräver ett object med ett object med en string som value

const saveObject = Joi.object().keys({
    name: Joi.string().required()
})

//const name = Joi.object().required()

module.exports = {
    '/savePlayer': saveObject,
};
